...
<html class="no-js">
	...
	<header id="fh5co-header" role="banner">
		<div class="container">
			<div class="header-inner">
				<h1><a href="<?php echo base_url().''?>">Jujur Sitangggang<span>.</span></a></h1>
				<nav role="navigation">
					<ul>
			...
			<ul class="slides">
		   	...
		   	<li style="background-image: url(<?php echo base_url().'theme/images/slide_2.jpg'?>);">
		   		<div class="container">
		   			<div class="col-md-10 col-md-offset-1 text-center js-fullheight slider-text">
		   				<div class="slider-text-inner">
		   					<h2>relationships and develop innovative solutions</h2>
		   					<p><a href="#" class="btn btn-primary btn-lg">Get started</a></p>
		   				</div>
		   			</div>
		   		</div>
		   	...
		   	<li style="background-image: url(<?php echo base_url().'theme/images/slide_3.jpg'?>);">
		   		<div class="container">
		   			<div class="col-md-10 col-md-offset-1 text-center js-fullheight slider-text">
		   				<div class="slider-text-inner">
		   					<h2>which help dynamic people.</h2>
		   					<p><a href="#" class="btn btn-primary btn-lg">Get started</a></p>
		   				</div>
		   			</div>
		   		</div>
		...
		<div class="container">
			<div class="row">
				...
				<div class="col-md-4 text-center item-block">
					...
					<h3>ADVERTISING</h3>
					<p>	Bussines Advertising antara lain Billboard dan LED display ( termasuk digital creative content).</p>
				...
				<div class="col-md-4 text-center item-block">
					...
					<p>	menawarkan solusi manajemen dan bisnis yang didukung oleh para konsultan berkualitas.</p>
					<p><a href="<?php echo base_url().'portfolio'?>" class="btn btn-primary btn-outline with-arrow">Learn more <i class="icon-arrow-right"></i></a></p>
				</div>
				<div class="col-md-4 text-center item-block">
	...
	<div class="fh5co-section-with-image">
		...
		<div class="fh5co-box animate-box">
			<h2>think smart</h2>
			<p>develop creative ideas, innovative ideas, inspiring thoughts and brilliant solutions.</p>
