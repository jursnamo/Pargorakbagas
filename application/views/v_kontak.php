	...
	<header id="fh5co-header" role="banner">
		<div class="container">
			<div class="header-inner">
				<h1><a href="<?php echo base_url().''?>">Jujur Sitanggang<span>.</span></a></h1>
				<nav role="navigation">
					<ul>
						<li><a href="<?php echo base_url().''?>">Home</a></li>
						<li><a href="<?php echo base_url().'about'?>">About</a></li>
						<li><a href="<?php echo base_url().'portfolio'?>">Portfolio</a></li>
						<li><a href="<?php echo base_url().'artikel'?>">Services</a></li>
			...
			<div class="row">
				<div class="col-md-3">
					...
					<ul class="contact-info">
						<li><i class="icon-map"></i>Jln.Ir.H.Djuanda No.3A/154 Rt/Rw 01/09 Kel.Dago Kec.Coblong Bandung </li>
						<li><i class="icon-phone"></i>+6285351364674</li>
						<li><i class="icon-envelope"></i><a href="#">soalparna@gmail.com</a></li>
						<li><i class="icon-globe"></i><a href="#">soalparna.blogspot.com</a></li>
					</ul>
				</div>
